...
try:
    ...
    from chronos.domain import survival as _survival
...
BASAL_COST = _survival.BASAL_COST
PLANET_EXTRA_COST = _survival.PLANET_EXTRA_COST

def get_basal_cost(profile: str, planet: Optional[str] = None) -> dict:
    return _survival.get_basal_cost(profile, planet)
...
ACTION_COST = _survival.ACTION_COST

def calculate_turn_cost(action: str, profile: str, planet: Optional[str] = None) -> dict:
    return _survival.calculate_turn_cost(action, profile, planet)
